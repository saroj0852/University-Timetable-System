// scripts/export_to_doc.js
// Reads the final JSON from /outputs and generates a .docx file.

const fs = require("fs");
const { Document, Packer, Paragraph, Table, TableRow, TableCell, WidthType, TextRun, ShadingType, AlignmentType } = require("docx");

// UPDATED PATHS
const inputPath = "./outputs/updated_timetable.json";
const outputPath = "./outputs/Timetable.docx";

// Load timetable data
const timetable = JSON.parse(fs.readFileSync(inputPath, "utf8"));
...
async function generateDoc() {
  ...
  console.log(`✅ Timetable.docx generated successfully at: ${outputPath}`);
}
