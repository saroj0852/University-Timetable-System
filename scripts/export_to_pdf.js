// scripts/export_to_pdf.js
// Reads the final JSON from /outputs and generates a PDF.
...
const outputPath = "./outputs/timetable.pdf";
...
console.log(`✅ Timetable PDF generated successfully at: ${outputPath}`);